    ...
    <main className="bg-[#050403] text-white">
      ...
      <section className="relative overflow-hidden border-b border-[#d6ad63]/20 px-4 py-24 md:py-32">
        ...
        <div className="container relative mx-auto max-w-6xl">
          <p className="mb-5 text-xs font-bold uppercase tracking-[0.26em] text-[#d6ad63]">
          ...
          <p className="mt-8 max-w-3xl text-lg leading-9 text-white/78 md:text-xl">
            {t(
              "黄启明是启明遁甲决策智库 Qimen Strategy 创始人及奇门遁甲企业决策顾问。16 年来长期以奇门遁甲协助企业主判断时机、方向、人事合作、风水空间与重大行动节奏，并结合真实企业经营与客户咨询经验，形成五维战略判断系统：天时、地利、人和、修为、成长。",
        ...
        <div className="container mx-auto grid max-w-6xl gap-12 md:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="mt-4 text-base leading-8 text-white/72">
                {t(
                  "立足新加坡，启明遁甲决策智库 Qimen Strategy 以中英双语服务企业主、创始人、专业人士与关键决策者。品牌定位为新加坡奇门遁甲企业决策顾问，帮助客户在商业、投资、合作、职业、住宅与办公室风水相关的关键行动前先看清全局。",
