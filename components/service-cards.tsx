...
const services = [
  ...
  },
  {
    ...
    icon: Heart,
    titleZh: "情绪与能量疗愈",
    titleEn: "Emotional & Energy Healing",
    painZh: "不仅是命理预测，更是心灵的重塑。",
    painEn: "Beyond fortune-telling — a transformation of your inner world.",
    descZh: "启明大师是新加坡少数同时拥有清华大学积极心理学认证与16年传统玄学实战经验的导师。独创「能量心理调频」疗法，将科学心智模型与命理智慧深度融合。",
    descEn: "Master Huang is one of the few practitioners certified in Tsinghua University's Positive Psychology programme with 16+ years of metaphysical expertise. His pioneering 'Energy-Psychology Alignment' method fuses scientific frameworks with ancient wisdom.",
    badgeZh: "清华大学积极心理学指导师",
    badgeEn: "Tsinghua Positive Psychology Certified",
    bulletZh: ["能量心理调频疗法", "科学心智模型指导", "命理轨迹阻碍识别"],
    bulletEn: ["Energy-Psychology Alignment", "Scientific mental frameworks", "Life path obstacle identification"],
    price: "$288",
    ctaZh: "预约心理能量咨询",
    ctaEn: "Book Healing Session",
