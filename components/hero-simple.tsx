...
const searchIntents = [
  { en: "Relationship & Career", zh: "感情与事业" },
  { en: "Business Decisions", zh: "企业经营与重大决策" },
  { en: "Qi Men Dun Jia", zh: "奇门遁甲" },
  { en: "Bazi & Feng Shui", zh: "八字命理与风水" },
];
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-black text-white">
      <div className="absolute inset-0">
        <img
          src={BG_IMAGE}
          alt={t("黄启明｜启明遁甲创始人", "Huang Qiming, Founder of Qimen Strategy in Singapore")}
      ...
      <div className="relative container flex min-h-screen items-center pb-16 pt-32 md:pb-24 md:pt-40">
        <div className="ml-auto w-full max-w-5xl text-left">
          ...
          >
            {t("个人咨询 · 企业战略顾问 · 奇门遁甲实战课程", "Personal Advisory · Business Strategic Advisory · Qi Men Courses")}
          </motion.h2>
          ...
          >
            <p>
              {t(
                "面对事业、感情、生意与人生重要选择，先看清局势，再决定下一步。可预约新加坡Bedok面谈或线上咨询。",
                "For career, relationship, business and other important decisions, gain a clearer view of the situation before taking the next step. Consultations are available in Bedok or online."
              )}
            </p>
          </motion.div>
          ...
          >
            {searchIntents.map((item) => (
              <div key={item.en} className="flex items-center gap-2 text-sm text-white/78">
                ...
                <span className="font-semibold text-[#efd79e]">{t(item.zh, item.en)}</span>
              </div>
            ))}
          </motion.div>
          ...
          >
            ...
            >
              ...
              {t("WhatsApp私密咨询", "WhatsApp for a Private Consultation")}
              <ArrowRight size={17} />
            </a>
            <Link
              href="#services"
            ...
            >
              {t("了解咨询服务", "Explore Our Advisory Services")}
              <ArrowRight size={16} />
            </Link>
          </motion.div>
        </div>
