...
const cases = [
  {
    ...
    descZh: "客户面对一项重要合作机会，表面条件优厚，但内心一直犹豫。黄启明以奇门决策判断合作时机、人事关系与隐藏阻力，帮助客户看清该合作中的消耗点与风险节奏。客户最终调整谈判条件，避免了后续更高成本的错误承诺。",
    descEn: "A client faced an important partnership with attractive surface conditions but persistent hesitation. Through Qimen Strategy, Huang Qiming reviewed timing, people dynamics and hidden resistance, helping the client see the potential drain and risk rhythm. The client adjusted the negotiation terms and avoided a higher-cost commitment.",
    metricLabelZh: "决策价值",
  ...
  },
  {
    ...
    descZh: "一位企业主计划转型新业务，但同时面对多个方向，迟迟无法决定。黄启明通过奇门局势判断，比较不同路径的时机、资源消耗与后续风险，帮助客户把优先级重新排序，先守住核心业务，再逐步推进新方向。",
    descEn: "A business owner planned to transition into a new direction but was caught between several options. Using Qimen Strategy, Huang Qiming compared timing, resource cost and risk patterns across the paths, helping the client reorder priorities, protect the core business first and move into the new direction step by step.",
    metricLabelZh: "战略价值",
  ...
  },
  {
    ...
    descZh: "客户准备快速推进一项重要计划，但局势中存在明显未稳定因素。黄启明从时机、人物、行动节奏与潜在阻力中判断，当下不宜贸然推进，而应先调整内部条件。客户延后行动并重新准备，后续执行节奏明显更稳。",
    descEn: "A client was ready to move quickly on an important plan, but the situation still carried unstable factors. Huang Qiming reviewed timing, key people, action rhythm and hidden resistance, advising against rushing and recommending internal preparation first. The client delayed the move, prepared more fully and later executed with a steadier rhythm.",
    metricLabelZh: "行动价值",
    ...
    <section id="cases" className="bg-[oklch(0.98_0.01_70)] py-20 md:py-32">
      <div className="container">
        ...
        >
          ...
          <h2 className="mb-4 text-4xl font-bold leading-tight md:text-5xl" style={{ fontFamily: "var(--font-cormorant), var(--font-noto-serif), serif", color: "oklch(0.15 0.02 60)" }}>
          ...
          <p className="text-base leading-relaxed text-[oklch(0.50_0.02_65)]" style={{ fontFamily: "var(--font-lato), var(--font-noto-sans), sans-serif" }}>
            {t(
              "以下案例以匿名方式呈现，重点不是夸大结果，而是展示启明遁甲决策智库如何在关键行动前帮助客户看清时机、方向、人事关系与局势风险。",
            ...
            >
              <div className="flex h-full flex-col border border-[oklch(0.25_0.02_60)] bg-white p-8">
                <div
                  ...
                  style={{ fontFamily: "var(--font-cormorant), var(--font-noto-serif), serif", color: "oklch(0.60 0.08 65)" }}
                >
                  {c.num}
                </div>

                <h3 className="mb-4 text-lg font-bold leading-snug md:text-xl" style={{ fontFamily: "var(--font-cormorant), var(--font-noto-serif), serif", color: "oklch(0.15 0.02 60)" }}>
                ...
                <div className="border-t border-[oklch(0.90_0.01_70)] pt-4">
                  <p className="mb-2 text-base font-bold md:text-lg" style={{ fontFamily: "var(--font-cormorant), var(--font-noto-serif), serif", color: "oklch(0.60 0.08 65)" }}>
