...
const appointmentFaqs = [
  ...
  },
  {
    ...
    aZh: "不做夸大承诺。启明遁甲决策智库提供战略判断、风险提示与行动建议，最终决定与执行仍由客户自行负责。",
...
export const wealthPageContent: ServicePageContent = {
  ...
  heroSubtitleZh:
    "启明遁甲决策智库以奇门决策为核心，结合现实商业处境、空间环境与个人节奏，帮助你看清事业卡点、财富路径、合作风险与下一步行动方向。",
  heroSubtitleEn:
  ...
  approachTitleZh: "启明遁甲决策智库如何辅助事业财富判断？",
  ...
  waTextZh: "你好，启明遁甲决策智库 Qimen Strategy，我想咨询事业财富与商业方向问题。",
...
export const healingPageContent: ServicePageContent = {
  ...
  heroSubtitleZh:
    "启明遁甲决策智库结合积极心理学视角、命理判断、空间环境与能量调和，帮助客户看清关系反复、情绪内耗与状态失衡背后的结构。",
  heroSubtitleEn:
  ...
  waTextZh: "你好，启明遁甲决策智库 Qimen Strategy，我想咨询关系、情绪与身心能量问题。",
...
export const decisionPageContent: ServicePageContent = {
  ...
  heroSubtitleZh:
    "启明遁甲决策智库将奇门遁甲转化为现代关键决策前的战略智慧决策方法。适用于合作、投资、签约、任用、转型、人生方向、关系与婚姻决策。",
  heroSubtitleEn:
  ...
  waTextZh: "你好，启明遁甲决策智库 Qimen Strategy，我想预约单项奇门决策咨询。",
...
export const spaceClearingPageContent: ServicePageContent = {
  ...
  heroSubtitleZh: "空间能量净化与环境调和作为启明遁甲决策智库的支持能力，统一采用预约制与服务范围报价。",
