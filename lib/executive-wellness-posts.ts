...
export const executiveWellnessPosts: InsightPost[] = [
  {
    ...
    paragraphs: [
      "Recently, a senior technical manager from a multinational corporation in Singapore visited Huang Qiming during a period of prolonged physical exhaustion and emotional pressure.",
      ...
      "During the consultation, Huang Qiming used Qi Men Dun Jia to analyze both the strategic structure surrounding his current work situation and the energetic patterns connected to his overall state.",
      ...
      "Huang Qiming explained that many modern professionals unknowingly remain in high-consumption states for years without proper restoration. Over time, this affects clarity, emotional stability, physical vitality and decision-making quality.",
      ...
      "Tian Yi Harmony Culture, formerly Qiming Feng Shui, is a Singapore-based Eastern wisdom brand founded by 黄启明 Huang Qiming. The organization integrates Qi Men Dun Jia strategy, Feng Shui spatial alignment, executive restoration, space energy alignment and sacred sound healing to support individuals and businesses in achieving greater clarity, emotional stability and long-term balance in modern life.",
    ],
  },
];
